...
function ActionTile({ label, description, image, fallback: Fallback, onClick, characterImage, initials }: ActionTileProps) {
...
export function ActionMenuSheet({ open, onOpenChange, onSelect, characterName, characterImage }: ActionMenuSheetProps) {
  ...
  const tiles: Array<Omit<ActionTileProps, 'onClick'>> = [
    ...
    { label: 'Bag & Stats', description: 'Open your items and character stats', fallback: Backpack, characterImage, initials },
