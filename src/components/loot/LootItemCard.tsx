    ...
    <>
      <motion.div
        ...
        className={cn(
          ...
          "border border-border/50 cursor-pointer active:scale-[0.99] transition-transform",
      ...
      >
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-foreground line-clamp-1 mb-1 flex items-center gap-1">
              {item.name}
