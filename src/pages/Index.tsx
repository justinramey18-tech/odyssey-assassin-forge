...
const UnifiedInventoryScreen = lazy(() => import('@/components/inventory/UnifiedInventoryScreen').then(m => ({ default: m.UnifiedInventoryScreen })));
const AchievementsScreen = lazy(() => import('@/components/achievements/AchievementsScreen').then(m => ({ default: m.AchievementsScreen })));
const ConstellationScreen = lazy(() => import('@/components/constellation/ConstellationScreen').then(m => ({ default: m.ConstellationScreen })));
...
const NarrativeForgeScreen = lazy(() => import('@/components/scribe/NarrativeForgeScreen').then(m => ({ default: m.NarrativeForgeScreen })));
const ChronicleSyncScreen = lazy(() => import('@/components/chronicle/ChronicleSyncScreen').then(m => ({ default: m.ChronicleSyncScreen })));
import { PromptDrawerProvider } from '@/components/drawers';

const AbilitiesScreen = lazy(() => import('@/components/abilities/AbilitiesScreen').then(m => ({ default: m.AbilitiesScreen })));
...
const CombatTabScreen = lazy(() => import('@/components/combat/CombatTabScreen').then(m => ({ default: m.CombatTabScreen })));
    ...
    partySync.broadcastStatus({
      ...
      spellSlots: !isRogueClass ? Object.fromEntries(
        Object.entries(classSpellcasting.state.spellSlots)
          .filter(([, s]) => typeof s === 'object' && 'max' in s && (s as any).max > 0)
