      ...
      <div className="min-h-screen flex-col p-4 flex items-center justify-end">
        ...
        <div className="w-full max-w-[22rem] flex flex-col items-center scale-[0.65] origin-center mt-[20px]">
          ...
          <form onSubmit={handleSignIn} className="w-full space-y-3">
              ...
              type="submit"
              disabled={loading}
              className="w-full py-3.5 mt-1 border-2 border-[#8b7355] text-[#d4c4a0] font-cinzel uppercase tracking-[0.2em] text-base hover:border-[#d4a030] disabled:opacity-50 transition-colors rounded-sm flex items-center justify-center gap-2 bg-[#4b3d2f]/[0.07]"
              style={{
