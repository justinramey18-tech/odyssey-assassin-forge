    ...
    extend: {
      ...
      keyframes: {
        ...
        "text-color-bleed": {
          ...
          "30%": { color: "rgb(200, 80, 40)" },
          "50%": { color: "rgb(180, 50, 20)" },
          "65%": { color: "rgb(210, 100, 50)" },
          "80%": { color: "rgb(240, 140, 70)" },
          "100%": { color: "inherit" },
        },
        "text-letter-scatter": {
          "0%": { letterSpacing: "0px", wordSpacing: "0px" },
          "12%": { letterSpacing: "0.8px", wordSpacing: "1.5px" },
          "30%": { letterSpacing: "-0.3px", wordSpacing: "2.5px" },
          "48%": { letterSpacing: "1.2px", wordSpacing: "-0.5px" },
          "62%": { letterSpacing: "-0.5px", wordSpacing: "3px" },
          "78%": { letterSpacing: "0.6px", wordSpacing: "1px" },
        ...
        "heartbeat-wobble-light": {
          "0%": { transform: "translate(0, 0) rotate(0deg)" },
          "5%": { transform: "translate(-0.5px, 0.3px) rotate(-0.1deg)" },
          "8%": { transform: "translate(0.3px, -0.2px) rotate(0.08deg)" },
          "13%": { transform: "translate(-0.3px, 0.2px) rotate(-0.06deg)" },
          "18%": { transform: "translate(0.4px, -0.3px) rotate(0.1deg)" },
          "22%": { transform: "translate(-0.2px, 0.1px) rotate(-0.04deg)" },
          "28%": { transform: "translate(0, 0) rotate(0deg)" },
          "100%": { transform: "translate(0, 0) rotate(0deg)" },
        },
        "heartbeat-wobble-medium": {
          "0%": { transform: "translate(0, 0) rotate(0deg)" },
          "6%": { transform: "translate(-1px, 0.5px) rotate(-0.15deg)" },
          "9%": { transform: "translate(0.6px, -0.4px) rotate(0.12deg)" },
          "15%": { transform: "translate(-0.7px, 0.5px) rotate(-0.1deg)" },
          "21%": { transform: "translate(0.8px, -0.5px) rotate(0.15deg)" },
          "26%": { transform: "translate(-0.4px, 0.2px) rotate(-0.06deg)" },
          "32%": { transform: "translate(0, 0) rotate(0deg)" },
          "100%": { transform: "translate(0, 0) rotate(0deg)" },
        },
        "heartbeat-wobble-heavy": {
          "0%": { transform: "translate(0, 0) rotate(0deg)" },
          "6%": { transform: "translate(-1.8px, 1px) rotate(-0.25deg)" },
          "10%": { transform: "translate(1.2px, -0.8px) rotate(0.2deg)" },
          "16%": { transform: "translate(-1.5px, 1px) rotate(-0.2deg)" },
          "22%": { transform: "translate(1.6px, -1px) rotate(0.25deg)" },
          "28%": { transform: "translate(-0.8px, 0.5px) rotate(-0.1deg)" },
